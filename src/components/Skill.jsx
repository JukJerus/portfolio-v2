        ...
        <div className="flex md:flex-row flex-col md:mx-40 mt-10 flex-wrap gap-4 w-s">
          {skills.map((skill, index) => {
            ...
            return (
              <div
                key={skill.name}
                className="flex h-15 w-9/10 md:w-100 mx-auto gap-2 items-center"
              >
          ...
          <div className="flex w-9/10 text-amber-50 font-medium text-lg md:w-100 mx-auto gap-2 items-center">
            {" "}
            And Keep Learning....
          </div>
        </div>
