export default function Contact() {
  return (
    <>
      <div className="flex flex-col md:flex-row mx-auto items-center md:gap-10 justify-evenly md:w-7/10 mt-20 p-3">
        ...
        <form className="w-full">
          <div className="relative z-0 w-full mb-5 group">
            <input
              ...
              name="floating_email"
              id="floating_email"
              className="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-amber-500 peer"
              placeholder=" "
              required
            />
            <label
